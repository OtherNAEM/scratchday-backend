...
io.on("connection", (socket) => {
  ...
  // Sync timer state with client
  socket.emit("sync", { endTime: countdownEndTime, isRunning });
  ...
  socket.on("startTimer", (durationInSeconds) => {
    if (!isRunning) {
      ...
      io.emit("sync", { endTime: countdownEndTime, isRunning });
    }
  });
  ...
  socket.on("resetTimer", () => {
    ...
    io.emit("sync", { endTime: null, isRunning });
  });
